...
# StoaGraph installer.
#
#   curl -sSL https://raw.githubusercontent.com/CurtisDSlone/stoagraph/v0.2.1/install.sh | sh
#
# ---------------------------------------------------------------------------------------------------
...
#
#   curl -sSLO https://raw.githubusercontent.com/CurtisDSlone/stoagraph/v0.2.1/install.sh
